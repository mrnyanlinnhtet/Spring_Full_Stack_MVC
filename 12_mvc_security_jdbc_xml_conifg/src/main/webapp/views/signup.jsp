            ...
            <div class="col-5">
             ...
             <div class="form-group my-4">
               <sf:label for="name" path="name"><b>Name : </b></sf:label>
                <sf:input path="name" type="text" name="name" id="name" class="form-control" placeholder="Enter Name !"/>
                <sf:errors path="name"></sf:errors>
               </div>
               
               <div class="form-group my-4">
               <sf:label for="loginId" path="loginId"><b>LoginId : </b></sf:label>
                <sf:input path="loginId" type="text" name="loginId" id="loginId" class="form-control" placeholder="Enter Login Id !"/>
                  <sf:errors path="loginId"></sf:errors>
               </div>
               
               <div class="form-group my-4">
               <sf:label for="password" path="password"><b>Password : </b></sf:label>
                <sf:input path="password" type="password" name="password" id="password" class="form-control" placeholder="Enter Password !"/>
